...
$requirements = [
    [
        ...
        'by' => 'Vplat',
        'memo' => 'PHP 8.1 or higher is required.',
    ],
    // Database :
    [
        'name' => 'PDO extension',
    ...
    [
        ...
        'by' => 'Media(Video) Service',
        'memo' => 'Required for file handling.',
    ],
    [
        'name' => 'PHP max file size for upload',
        'mandatory' => false,
        'condition' => $requirementsChecker->checkUploadMaxFileSize("2024MB", "4096MB"),
        'by' => 'Media(Video) Service',
        'memo' => '"post_max_size" and "upload_max_filesize" should be between 2024MB and 4096MB at php.ini',
    ],
];
